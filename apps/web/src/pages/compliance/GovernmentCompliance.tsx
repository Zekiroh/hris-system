            ...
            <div className="space-y-5">
              ...
              <div className="rounded-xl border border-gray-100 bg-gray-50 p-5">
                <p className="text-sm text-gray-600">
                  ...
                  configuration APIs. Monitoring, remittance, and reporting tabs
                  remain unchanged for the future reporting layer.
                </p>
              </div>
                        ...
                        configuration.philhealth.map((rule) => (
                          <tr key={rule.id}>
                            ...
                            <td>
                              <div className="flex gap-1">
                                <button
                                  onClick={() => openEditConfigurationModal("philhealth", rule)}
                                  className="btn-ghost btn-icon text-gray-400 hover:bg-gray-100"
                                ...
                                {rule.isActive && (
                                  <button
                                    onClick={() => deactivateConfigurationRule("philhealth", rule)}
                                    className="btn-ghost btn-icon text-gray-400 hover:bg-gray-100"
                        ...
                        configuration.pagibig.map((rule) => (
                          <tr key={rule.id}>
                            ...
                            <td>
                              <div className="flex gap-1">
                                <button
                                  onClick={() => openEditConfigurationModal("pagibig", rule)}
                                  className="btn-ghost btn-icon text-gray-400 hover:bg-gray-100"
                                ...
                                {rule.isActive && (
                                  <button
                                    onClick={() => deactivateConfigurationRule("pagibig", rule)}
                                    className="btn-ghost btn-icon text-gray-400 hover:bg-gray-100"
