...
import { getOvertimeRequests, reviewOvertimeRequest } from '../../lib/attendance';
                ...
                <div className="pro-modal-overlay">
                    <div className="pro-modal max-w-md w-full mx-4 sm:mx-auto" onClick={e => e.stopPropagation()}>
                        <div className="pro-modal-header">
                            ...
                            <button onClick={() => setShowOvertimeModal(false)} className="btn-ghost btn-icon">
                                <X className="w-5 h-5 text-gray-400" />
                            </button>
                        </div>
                        <div className="pro-modal-body space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="time" className="pro-input" />
                                </div>
                                <div>
                        ...
                        <div className="pro-modal-footer flex-col sm:flex-row gap-2 sm:gap-0">
                            <button onClick={() => setShowOvertimeModal(false)} className="btn btn-secondary w-full sm:w-auto">
                                Cancel
                            </button>
                            <button onClick={() => setShowOvertimeModal(false)} className="btn btn-primary w-full sm:w-auto">
                                Submit Request
                            </button>
                        </div>
                    </div>
