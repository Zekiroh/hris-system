  ...
  return (
    <header className="h-16 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-20 bg-white/80 backdrop-blur-xl border-b border-gray-100">
      ...
      <div className="hidden md:flex items-center gap-4">
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-emerald-500 text-white px-4 py-1.5 rounded-full text-xs font-semibold shadow-sm flex items-center gap-2 whitespace-nowrap">
