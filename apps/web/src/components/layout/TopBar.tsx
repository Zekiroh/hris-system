      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className={`relative p-2 rounded-xl transition-colors group ${
              showNotifications ? "bg-emerald-50 text-emerald-600" : "hover:bg-gray-100 text-gray-500"
            }`}
          >
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
          ...
          <div className="hidden lg:block">
            <p className="text-xs font-semibold text-gray-800">{isAdmin ? "Admin User" : "Employee User"}</p>
            <p className="text-[10px] text-gray-400">{isAdmin ? "HR Administrator" : "Employee"}</p>
          </div>
        </div>
      </div>
    </header>
