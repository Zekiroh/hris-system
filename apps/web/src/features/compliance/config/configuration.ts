...
> = {
  ...
  philhealth: [
    { key: "contributionRate", label: "Contribution Rate (decimal 0–1)", type: "number" },
    ...
    { key: "employeeSharePercent", label: "Employee Share (decimal 0–1)", type: "number" },
    { key: "employerSharePercent", label: "Employer Share (decimal 0–1)", type: "number" },
    { key: "effectiveFrom", label: "Effective From", type: "date" },
    { key: "effectiveTo", label: "Effective To", type: "date" },
    { key: "isActive", label: "Active", type: "checkbox" },
  ],
  pagibig: [
    { key: "employeeRate", label: "Employee Rate (decimal 0–1)", type: "number" },
    { key: "employerRate", label: "Employer Rate (decimal 0–1)", type: "number" },
    { key: "minimumContribution", label: "Minimum Contribution", type: "number" },
    { key: "maximumContribution", label: "Maximum Contribution", type: "number" },
    { key: "effectiveFrom", label: "Effective From", type: "date" },
    { key: "effectiveTo", label: "Effective To", type: "date" },
  ...
  tax: [
    ...
    { key: "taxRate", label: "Tax Rate (decimal 0–1)", type: "number" },
    { key: "effectiveFrom", label: "Effective From", type: "date" },
    { key: "effectiveTo", label: "Effective To", type: "date" },
    { key: "isActive", label: "Active", type: "checkbox" },
  ],
